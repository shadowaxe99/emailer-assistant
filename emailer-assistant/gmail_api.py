...
def get_gmail_service():
    ...
    if creds and not creds.valid:
        ...
        flow = InstalledAppFlow.from_client_secrets_file(
            "REDACTED", ["https://www.googleapis.com/auth/gmail.modify"]
        )
...
def reply_to_email(service, original_message, reply_content):
    ...
    references = next(
        (header["value"] for header in headers if header["name"] == "References"), None
    )
    ...
    message = {"raw": base64.urlsafe_b64encode(raw_email).decode("utf-8")}
